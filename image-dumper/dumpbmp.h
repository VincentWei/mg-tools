...
extern int make_file_begin (void);
extern int make_file_end (void);
extern void dump_from_file (HDC hdc, const char* file);

extern void make_loader_begin(void);
extern void make_loader_end(void);
#ifdef __cplusplus
}
#endif  /* __cplusplus */
