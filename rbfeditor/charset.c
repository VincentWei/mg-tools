/*
** $Id: charset.c,v 1.1 2008-02-19 11:32:54 wangxuguang _exp $
** 
...
#if defined(_MGCHARSET_GB) | defined(_MGCHARSET_GBK) | defined(_MGCHARSET_BIG5) \
        | defined(_MGCHARSET_EUCKR) | defined(_MGCHARSET_EUCJP) \
...
{
    return (UChar32)gbunicode_map [glyph_value];
}
...
static UChar32 gbk_conv_to_uc32 (Glyph32 glyph_value)
{
    ...
    return (UChar32)gbkunicode_map[glyph_value];
}
...
static UChar32 gb18030_0_conv_to_uc32 (Glyph32 glyph_value)
{
    ...
    if (glyph_value > 63611)
        ...
        return (UChar32)gb18030_0_unicode_map [glyph_value];
}
...
{
    unsigned short ucs_code = big5_unicode_map [glyph_value];
...
{
    unsigned short ucs_code = ksc5601_0_unicode_map [glyph_value];
...
static UChar32 jisx0208_0_conv_to_uc32 (Glyph32 glyph_value)
{
    ...
    ucs_code = jisx0208_0_unicode_map [glyph_value];
...
static UChar32 jisx0208_1_conv_to_uc32 (Glyph32 glyph_value)
{
    ...
    ucs_code  = jisx0208_1_unicode_map [glyph_value];
...
int nr_charsets = (sizeof(charsets)/sizeof(CHARSETOPS*));
